/**
 * Composed, opinionated pieces built from the primitives.
 *
 * These encode product decisions (what a status pill means, how a group tile is
 * laid out) rather than raw visual atoms, which is why they live apart from
 * primitives.tsx even though they are equally shared.
 */
...
import { STATUS_ICON, statusStyle, type StatusKey } from '~/shared/theme';
import { useTheme } from '~/shared/theme/ThemeProvider';
import { Divider, Glyph, Label, Row, Surface, Text } from './primitives';
