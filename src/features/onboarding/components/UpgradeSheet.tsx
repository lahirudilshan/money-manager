...
import { planFor, type Feature } from '~/features/budget/logic/plans';
import { useAppStore } from '~/store/useAppStore';
import { useTheme } from '~/shared/theme/ThemeProvider';
import { SMART_DETECT_NAME, SMART_DETECT_TAGLINE, SmartDetectBadge } from '~/features/sms/components/SmartDetectBadge';
